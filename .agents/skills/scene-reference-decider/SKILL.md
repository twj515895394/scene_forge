...
- 是否保留经典台词、原版对白、具体镜头组合、服装轮廓或高识别表达，由当前项目创作目标和风格转译方式决定；系统默认不一刀切禁止。
- 当项目明确从真人/实拍/既有影视表达转成动画、风格化 3D、漫画化或其他明显不同的视觉系统时，可以继承镜头功能、动作节奏、关键姿态、服装轮廓锚点和表演意图，但必须说明转译方式，避免无改造照搬演员身份、字幕版式、平台水印、品牌元素和完整可识别镜头组合。
