...
- `assets/`：长期复用资产库，保存角色、场景、核心道具、动画风格化效果库与反差喜剧模板。
...
当前协议基线见 [docs/协议层与选题闸门设计.md](docs/协议层与选题闸门设计.md)。v4 实施计划见 [docs/SceneForge-v4-Implementation-Plan.md](docs/SceneForge-v4-Implementation-Plan.md)。
